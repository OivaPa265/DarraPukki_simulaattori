...
def liikuminen(peli_id, target_icao):
    ...
    vanha_info = kentta_info(current_icao)
    uusi_info = kentta_info(target_icao)

    lat1, lon1 = vanha_info[0]['latitude_deg'], vanha_info[0]['longitude_deg']
    lat2, lon2 = uusi_info[0]['latitude_deg'], uusi_info[0]['longitude_deg']
