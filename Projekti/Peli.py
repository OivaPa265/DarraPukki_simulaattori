    ...
    while True:
        ...
        if syote == "":
         ...
         "Pukki päätti käytää hänen taikavoimiaan ja oppi lentämään alkoholin avulla \n")
            ...
            if uudeleen_kys =="BEEES":
             for line in BEEES.beees():
                print(line)
...
# määritää hävijön sek' voiton ehdot
hävijö = False
voitto = False
...
#I am insane. I am a madman. I am a lunatic. I am a crazy person. I am a psychopath. I am a sociopath. I am a nutcase. I am a basket case. I am a loony.
#I am a screwball. I am a fruitcake. I am a loon. I am a kook. I am a crackpot. I am a whacko. I am a mental case. I am a basket case.
# I am a certifiable lunatic. I am off my rocker. I am out of my mind. I have lost my marbles. I am not playing with a full deck.
#. I am a few cards short of a full deck. I am not all there. I am a few bricks short of a full load. I am not firing on all cylinders.

    # muute fiksaa tää mulle on tullu joillai peli kerroilla aloitus paikalle merkki/C2H5OH vaik sen ei pitäis antaa mitää
    ...
    if goal:
        ...
        if vastaus == "KYLLÄ":
            # Keräämme tehtävän ja päivitämme tietokantaa
...
# kysyy pelaajalta jos tämä tahtoo pidentaa matkustus pituutaan uhraamalla vähän alkoholia
    ...
    if Valmis== "KYLLÄ":
        if current_alcohol >= 200:
            ...
            cursor = Yhdiste.cursor(dictionary=True)
            sql = "UPDATE game SET player_range = %s, alcohol = %s WHERE id = %s"
            cursor.execute(sql, (new_range, new_alcohol, peli_id))

            # Päivitää alkoholin ja liikumis määrän uusiksi jos pelaaja juo alkohlia
            ...
            LisäC2H5OH=input("Haluato saada vielä enemmän liikumis matkaa voit juoda toiset 200ml alkoholia ja saada lisä 500m matkaa\n"
                             ":Kyllä/ei").upper()
            if LisäC2H5OH == "KYLLÄ":
                if new_alcohol >= 200:  # Use updated alcohol amount
                    new_range = new_range + 500
                    new_alcohol = new_alcohol - 200
                    ...
                    print(f"olet nyt juonut 400ml alkoholia vvähäisitä varoistasi sinulla on nyt vain  {new_alcohol}ml alkoholia :(\n")
    ...
    # printää tän jos pelaaja kirjoitaa jotain joka ei ole listassa
    except ValueError:
        print("Ooko nää juonu ku ei ossaa luke numeroita listasta")


# I HATE THIS FIELD I HATE HAT ETHIS FIELD I HATE THIS FIELD I HATE THIS FIELD I HATE I HATE I HATE
# I CANT I CANT I JUST FUCKING CANT I CANT TAKE IT I JUST FUCKING CANT
